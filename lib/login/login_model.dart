...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for Logi-Email widget.
  FocusNode? logiEmailFocusNode;
  TextEditingController? logiEmailTextController;
  String? Function(BuildContext, String?)? logiEmailTextControllerValidator;
  String? _logiEmailTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  void initState(BuildContext context) {
    ...
    logiEmailTextControllerValidator = _logiEmailTextControllerValidator;
  ...
  void dispose() {
    ...
    logiEmailFocusNode?.dispose();
    logiEmailTextController?.dispose();
