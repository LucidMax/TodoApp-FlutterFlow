...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.logiEmailTextController ??= TextEditingController();
    _model.logiEmailFocusNode ??= FocusNode();
                              ...
                              child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.logiEmailTextController,
                                      focusNode: _model.logiEmailFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.logiEmailTextController',
                                        const Duration(milliseconds: 2000),
                                        () => safeSetState(() {}),
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .primaryText,
                                      validator: _model
                                          .logiEmailTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                  SizedBox(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          final user = await authManager.signInWithEmail(
                            context,
                            _model.logiEmailTextController.text,
